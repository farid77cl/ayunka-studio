...
(function () {
  ...
  /* ---------- colores (slots del CFS de la K2 Combo) ---------- */
  const COLORES = [
    { i: 1, nombre: 'Color 1', hex: '#CB5A52' },
    { i: 2, nombre: 'Color 2', hex: '#ECE6DA' },
    { i: 3, nombre: 'Color 3', hex: '#5F7C8E' },
    { i: 4, nombre: 'Color 4', hex: '#C27A4E' }
  ];
