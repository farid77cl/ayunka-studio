const CACHE='ayunka-studio-v31';
const ASSETS=['./','./index.html','./css/styles.css','./js/plan-data.js','./js/store.js','./js/idb.js','./js/calc.js','./js/filament-colors.js','./js/designs.js','./js/sync.js','./js/viewer.js','./js/supa.js','./js/app.js','./js/pdf.js','./img/logo.png','./favicon.ico','./favicon.png','./manifest.webmanifest'];
